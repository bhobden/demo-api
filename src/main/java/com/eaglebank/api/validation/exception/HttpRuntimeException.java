 ...
 * used as a base class for more specific exceptions (such as validation or
...
public class HttpRuntimeException extends RuntimeException {
    ...
    /**
     * Constructs a new HttpRuntimeException with the specified detail message and
     * status code.
     *
    ...
    /**
     * Constructs a new HttpRuntimeException with the specified detail message,
